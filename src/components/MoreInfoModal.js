    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-x-0 bottom-0 z-50 flex flex-col rounded-t-3xl border-t border-white/20 bg-white/50 text-gray-900 shadow-2xl backdrop-blur-2xl dark:bg-black/50 dark:text-white"
        >
          <div
            className="absolute inset-0 blur-md opacity-40 pointer-events-none" // Adjust blur and opacity as needed
            ...
            <div className="relative z-10 mx-auto max-w-6xl text-left">
              ...
              <div className="flex items-start justify-between p-6 md:px-12">
                ...
                <button
                  ...
                  className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-black/5 text-xl text-gray-600 transition-colors hover:bg-black/10 dark:bg-white/10 dark:text-gray-400 dark:hover:bg-white/20 cursor-pointer"
                >
                  ✕
                </button>
              </div>
